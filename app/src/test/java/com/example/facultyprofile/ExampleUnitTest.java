...
public class ExampleUnitTest {
    ...
    @Test
    public void validationtest_searchactivityforstrings2() {
        SearchActivity s=new SearchActivity();
        assertTrue(s.validateallstring("Ganesh Neelakanta Iyer12"));
    }
    @Test
    ...
    @Test
    public void validationtest_searchactivityfornumbers2() {
        ProfileActivity p = new ProfileActivity();
        assertTrue(p.validateallnumber("9G"));
    }
